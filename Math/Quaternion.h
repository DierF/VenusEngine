...
namespace VenusEngine
{
    ...
    public:
        ...
        Quaternion(Radian const& angle, Vec3 const& axis) { this->fromAngleAxis(angle, axis); }
        ...
        void fromAngleAxis(Radian const& angle, Vec3 const& axis);

        static Quaternion getQuaternionFromAngleAxis(Radian const& angle, Vec3 const& axis);
